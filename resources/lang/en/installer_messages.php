...
return [
     ...
     *
     */
    'title' => 'Εγκατάσταση My Island App',
    'next' => 'Επόμενο',
    'back' => 'Πίσω',
    'finish' => 'Εγκατάσταση',
    'forms' => [
     ...
     */
    'requirements' => [
        'templateTitle' => 'Bήμα 1 | Server Requirements',
     ...
     */
    'permissions' => [
        'templateTitle' => 'Bήμα 2 | Δικαιώματα',
        'title' => 'Δικαιώματα',
        'next' => 'Ρυθμίσεις Περιβάλλοντος',
    ],
     ...
     */
    'installed' => [
        'success_log_message' => 'To My Island App εγκαταστάθηκε επιτυχώς στο ',
    ],
